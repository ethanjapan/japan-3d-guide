...
export const STRINGS = {
  zh: {
    ...
    moveMode: "移動",
    locate: "顯示目前位置",
    gpsOutside: "目前位置在日本範圍外",
    gpsFail: "無法取得位置(請確認定位權限)",
    route: "路線・轉乘(Google Maps)",
    planTitle: "旅遊計畫",
  ...
  ja: {
    ...
    moveMode: "移動",
    locate: "現在地を表示",
    gpsOutside: "現在地は日本の外です",
    gpsFail: "位置を取得できません(位置情報の許可を確認)",
    route: "経路・乗換(Google Maps)",
    planTitle: "旅の計画",
    planHint: "行きたい観光地を集めて、プロンプトをコピーし、自分のChatGPTに貼って旅程を相談できます。",
    planAdd: "計画に追加",
    planAdded: "追加済み",
    ...
    planClear: "すべて消す",
    planEmpty: "まだ観光地がありません。観光地を開いて「計画に追加」を押してください。",
  ...
  cn: {
    ...
    moveMode: "移动",
    locate: "显示当前位置",
    gpsOutside: "当前位置在日本范围外",
    gpsFail: "无法获取位置(请确认定位权限)",
    route: "路线・换乘(Google Maps)",
    planTitle: "旅游计划",
  ...
  en: {
    ...
    gpsOutside: "You are outside Japan",
